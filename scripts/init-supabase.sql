-- ============================================================
-- LeaveFlow Pro - สคริปต์สร้างฐานข้อมูลบน Supabase
-- ============================================================
-- วิธีใช้:
--   1. สร้างโปรเจกต์ที่ https://supabase.com
--   2. ไปที่ SQL Editor → New query → วางสคริปต์นี้ → Run
--   3. Connection string ดูที่ Project Settings → Database
-- ============================================================
...
-- หมายเหตุ: ตาราง users ให้เพิ่มข้อมูลผ่าน Backend API (รหัสผ่านต้อง hash ด้วย bcrypt)
